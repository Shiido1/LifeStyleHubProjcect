class Paths {
  ...
  static String dashboardVp = 'api/dashboard/vp';
  static String dashboardVPP = 'api/dashboard/vpp';
  ...
  static String makePayment = 'api/packages/';
  static String fundWallet = 'api/wallet/fund';
  ...
  static String freeSignUpMember =
      '/api/reports/vpp/free-trial-members/signups';
