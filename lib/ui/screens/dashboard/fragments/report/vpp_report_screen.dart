...
class VppReportScreen extends StatefulWidget {
  const VppReportScreen({Key? key}) : super(key: key);

  @override
  _VppReportScreenState createState() => _VppReportScreenState();
}

class _VppReportScreenState extends State<VppReportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<ReportViewmodel>(builder: (_, provider, __) {
        return Padding(
          ...
          child: ListView(
            children: [
              ...
              _container(
                  point:
                      provider.reportPromotionSummaryModel?.totalCommission ??
                          0,
                  text: 'Total\nCommission',
