class MyAccountsModelList {
  final List<MyAccountsModel>? myAccountModelList;

  MyAccountsModelList({this.myAccountModelList});

  factory MyAccountsModelList.fromJson(List<dynamic> parsedJson) {
    List<MyAccountsModel> _viewPackagesModel = [];
    _viewPackagesModel =
        parsedJson.map((i) => MyAccountsModel.fromJson(i)).toList();

    return MyAccountsModelList(myAccountModelList: _viewPackagesModel);
  }
}
...
class MyAccountsModel {
  ...
  MyAccountsModel.fromJson(Map<String, dynamic> json) {
