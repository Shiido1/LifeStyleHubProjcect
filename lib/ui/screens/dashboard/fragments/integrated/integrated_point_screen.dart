...
class _IntegratedPointScreenState extends State<IntegratedPointScreen> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<ValueListenable<Box>?> snapshot) {
                ...
                child: ListView(
                  children: [
                    IntegratedPointAndCommissionWidget(
                      ...
                      totalClaimed: '${_point.claimedPointBalance ?? 0}',
                    ),
                    SizedBox(height: 23),
                    TextView(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: TextView(
                                                  text: point.type == 'credit'?
                                                      'Subscribed for ${point.package} ':
                                                      'Checkout for ${point.package}',
