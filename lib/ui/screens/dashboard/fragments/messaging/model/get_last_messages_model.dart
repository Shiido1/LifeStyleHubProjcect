...
class GetLastMessagesModel {
  ...
  GetLastMessagesModel({this.currentPage, this.data, this.firstPageUrl, this.from, this.lastPage, this.lastPageUrl, this.links, this.nextPageUrl, this.path, this.perPage, this.prevPageUrl, this.to, this.total});
...
class Data {
  ...
  Data({this.id, this.conversationId, this.messageableId, this.messageableType, this.settings, this.createdAt, this.updatedAt, this.private, this.directMessage, this.data, this.conversation});
...
class Conversation {
  ...
  Conversation({this.id, this.private, this.directMessage, this.data, this.createdAt, this.updatedAt, this.lastMessage, this.participants});
  ...
  Conversation.fromJson(Map<String, dynamic> json) {
    ...
    if(json["last_message"] is Map)
      this.lastMessage = json["last_message"] == null ? null : LastMessage.fromJson(json["last_message"]);
...
class Participants {
  ...
  Participants({this.id, this.conversationId, this.messageableId, this.messageableType, this.settings, this.createdAt, this.updatedAt, this.messageable});
  ...
  Participants.fromJson(Map<String, dynamic> json) {
    ...
    if(json["messageable"] is Map)
      this.messageable = json["messageable"] == null ? null : Messageable1.fromJson(json["messageable"]);
  }
...
class Messageable1 {
  ...
  Messageable1({this.id, this.name, this.email, this.emailVerifiedAt, this.phoneNo, this.state, this.address, this.sex, this.dob, this.status, this.referredBy, this.affiliateId, this.trialEnds, this.isAdmin, this.role, this.createdAt, this.updatedAt, this.participation});
  ...
  Messageable1.fromJson(Map<String, dynamic> json) {
    ...
    if(json["affiliate_id"] is Map)
      this.affiliateId = json["affiliate_id"] == null ? null : AffiliateId2.fromJson(json["affiliate_id"]);
    ...
    if(json["participation"] is List)
      this.participation = json["participation"]==null ? null : (json["participation"] as List).map((e)=>Participation3.fromJson(e)).toList();
  }
...
class Participation3 {
  ...
  Participation3({this.id, this.conversationId, this.messageableId, this.messageableType, this.settings, this.createdAt, this.updatedAt});
...
class LastMessage {
  ...
  LastMessage({this.id, this.messageId, this.messageableId, this.messageableType, this.conversationId, this.participationId, this.isSeen, this.isSender, this.flagged, this.createdAt, this.updatedAt, this.deletedAt, this.body, this.type, this.sender, this.participation});
  ...
  LastMessage.fromJson(Map<String, dynamic> json) {
    ...
    if(json["is_seen"] is int)
      this.isSeen = json["is_seen"];
    if(json["is_sender"] is int)
      this.isSender = json["is_sender"];
    if(json["flagged"] is bool)
