...
class Bank {
  ...
  Bank({this.userId, this.name, this.accountName, this.accountNo, this.sortCode, this.swiftCode, this.updatedAt, this.createdAt, this.id});
...
class Work {
  ...
  Work({this.userId, this.occupation, this.industry, this.address, this.updatedAt, this.createdAt, this.id});
